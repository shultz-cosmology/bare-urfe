...
1. 🟢 **[NOVEL_PREDICTIONS.md](/NOVEL_PREDICTIONS.md)**: **START HERE.** The 0.781 attractor targets for the Oct 2026 Euclid release.
2. ⚖️ **[GOLDILOCKS_AUDIT](/code/goldilocks_audit.py)**: The Logical Filter. Proves $N=4$ is the unique stable dimensionality for the URFE attractor.
3. 📘 **[TOPOLOGICAL_PROOF.md](/TOPOLOGICAL_PROOF.md)**: Proof of the 0.75 Trace-Class Invariant (The Floor).
